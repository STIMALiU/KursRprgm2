...
\section{Inför del 2 på kursen}\label{del2}

\begin{frame}{Inför del 2 på kursen}
\phantomsection\label{funktioner---repetition}

\begin{itemize}
\tightlist
\item
  Olika tillämpningar av statistik och dataanalys  
\item
  Inlämning 3 och 4 + projekt görs i par  
\item
  Anmäl er til grupper på kursrummet
\item
  Går endast att lämna in om man är i en grupp
\item
  Gruppkontrakt: \href{github.com/STIMALiU/KursRprgm2/blob/main/Labs/Documents/Gruppkontrakt mall_732G33_732G83.docx?raw=true}{här}
