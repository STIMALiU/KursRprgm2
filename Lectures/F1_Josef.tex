...
Kollar man på tidigare kursutvärderingar har kursen fungerat bra överlag. 

Dock: 2025 fick vi in 1/40 möjliga svar på utvärderingen.
...
\item 
  Projektet kommer att bli lite mindre jämfört med förra året
\end{itemize}
\end{block}
\end{frame}
...
\item
  ...
  \tightlist
  \item
    Lämnas in på kursrummet på Lisam, varannan söndag från kursvecka 3
  \item
...
\item
  2 inlämningar
\item
  Inlämningsuppgifterna görs \textbf{en och en}
\end{itemize}
\end{frame}
...
\item
  Fyra föreläsningar
\item
  2 inlämningar + \textbf{projekt}
\item
  Inlämningsuppgifterna och projektet görs genom \textbf{parprogrammering} (grupper om två)
\end{itemize}
...
\item
  ...
  \item
    Schamalagda datorlaborationer (4 h), läs kurslitteratur/se videor (1 h)
  \item
