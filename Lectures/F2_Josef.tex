...
\phantomsection\label{fuxf6reluxe4sning-2}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{variabler-vektorer-och-typer}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{funktioner}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{datastrukturer-1}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{matriser-1}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{matriser-exempel}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{demo-matriser}
\end{block}
\end{frame}
...
\phantomsection\label{data.frame-1}
\begin{itemize}
\tightlist
\item
  Dataset i R
...
\item
  ...
  \item 
    Vissa R-paket innehåller fler dataset som kan läsas in med \texttt{data()}
  \end{itemize}
\end{itemize}
\end{frame}

\begin{frame}[fragile]{Exempel på inbyggt dataset}
\phantomsection\label{exempel-puxe5-inbyggt-dataset}
\begin{figure}
\centering
...
\phantomsection\label{skapa-en-data.frame}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{variabler}
\begin{itemize}
\tightlist
\item
  Varje kolumn är en vektor
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{minData}\SpecialCharTok{$}\NormalTok{langd}
\NormalTok{minData[, }\StringTok{"langd"}\NormalTok{]}
\NormalTok{minData[, }\DecValTok{3}\NormalTok{]}
\NormalTok{minData[[}\StringTok{"langd"}\NormalTok{]]}
\NormalTok{minData[, }\FunctionTok{colnames}\NormalTok{(minData) }\SpecialCharTok{==} \StringTok{"langd"}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
\end{frame}

\begin{frame}[fragile]{Nya variabler}
\phantomsection\label{nya-variabler}
\begin{itemize}
\tightlist
\item
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{minData}\SpecialCharTok{$}\NormalTok{langdMeter }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\FloatTok{1.8}\NormalTok{, }\FloatTok{1.7}\NormalTok{, }\FloatTok{1.1}\NormalTok{)}
\NormalTok{minData}\SpecialCharTok{$}\NormalTok{rolig }\OtherTok{\textless{}{-}} \StringTok{"Ja"}
\NormalTok{minData}
\end{Highlighting}
\end{Shaded}
...
\phantomsection\label{ta-bort-variabler}
\begin{itemize}
\tightlist
\item
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{minData }\OtherTok{\textless{}{-}}\NormalTok{ minData[, }\SpecialCharTok{{-}}\DecValTok{4}\NormalTok{] }
\NormalTok{minData}\SpecialCharTok{$}\NormalTok{rolig }\OtherTok{\textless{}{-}} \ConstantTok{NULL}
\NormalTok{minData}
\end{Highlighting}
\end{Shaded}
...
\phantomsection\label{variabelnamn}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{demo-data.frame}
\end{block}
\end{frame}
...
\phantomsection\label{indexering-i-listor}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{demo-listor}
\end{block}
\end{frame}
...
\phantomsection\label{sammanfoga-data}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{demo-databearbetning}
\end{block}
\end{frame}
...
\begin{frame}{Demo}
\phantomsection\label{demo-4}
\begin{block}{Demo: Input och Output}
\phantomsection\label{demo-input-och-output}
\end{block}
\end{frame}
