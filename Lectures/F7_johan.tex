...
\urlstyle{same}
\hypersetup{
  pdftitle={R-programmering VT26},
  pdfauthor={Johan Alenlöv},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{\texorpdfstring{R-programmering VT26}{R-programmering VT26}}
\subtitle{\texorpdfstring{Föreläsning 7}{Föreläsning 7}}
...
\protect\phantomsection\label{innehuxe5ll-fuxf6reluxe4sning-7}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{ggplot2}
\protect\phantomsection\label{ggplot2-1}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{grammar-of-graphics}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{ggplot2}
\protect\phantomsection\label{ggplot2-2}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{ggplot2}
\protect\phantomsection\label{ggplot2-3}
\pandocbounded{\includegraphics[keepaspectratio,alt={alt text}]{images/grammar-of-graphics.png}}
Bild från ``R for the rest of us''
\end{frame}

\begin{frame}{ggplot2}
\protect\phantomsection\label{ggplot2-4}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Grammar of Graphics}
\protect\phantomsection\label{grammar-of-graphics-1}
\begin{quote}
...
\protect\phantomsection\label{aesthetic-aes}
...
\protect\phantomsection\label{geometric-geom}
...
\protect\phantomsection\label{aes-och-geom}
...
\protect\phantomsection\label{exempel---i}
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{exempel---ii}
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ Nile) }\SpecialCharTok{+} 
  \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ years, }\AttributeTok{y =}\NormalTok{ level) }\SpecialCharTok{+} 
...
\protect\phantomsection\label{exempel---iii}
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ Nile) }\SpecialCharTok{+} 
...
\protect\phantomsection\label{exempel---iv}
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ Nile) }\SpecialCharTok{+} 
  \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ years, }\AttributeTok{y =}\NormalTok{ level, }\AttributeTok{color =}\NormalTok{ period) }\SpecialCharTok{+} 
...
\protect\phantomsection\label{exempel---v}
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ Nile) }\SpecialCharTok{+} 
  \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ years, }\AttributeTok{y =}\NormalTok{ level) }\SpecialCharTok{+} 
...
\protect\phantomsection\label{exempel---vi}
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{exempel---vii-teman}
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{exempel---viii-teman}
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{exempel---ix-teman}
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{exempel---x-teman}
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{demo-ggplot}
\end{block}
\end{frame}
...
\protect\phantomsection\label{enklare-statistika-tester}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{exempel-t.test---i}
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{exempel-t.test---ii}
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{exempel-t.test---iii}
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{demo-statistik}
\end{block}
\end{frame}
...
\protect\phantomsection\label{linjuxe4r-regression-1}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{linjuxe4r-regression---anpassa-en-modell}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{linjuxe4r-regression---analysera-modellen}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{linjuxe4r-regression---diagnostisera}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{linjuxe4r-regression---anvuxe4nda-modellen}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{demo-linjuxe4r-regression}
\end{block}
\end{frame}
