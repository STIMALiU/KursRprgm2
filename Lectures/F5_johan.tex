...
\urlstyle{same}
\hypersetup{
  pdftitle={R-programmering VT2026},
  pdfauthor={Johan Alenlöv},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{\texorpdfstring{R-programmering VT2026}{R-programmering VT2026}}
\subtitle{\texorpdfstring{Föreläsning 5}{Föreläsning 5}}
\author{\texorpdfstring{Johan Alenlöv}{Johan Alenlöv}}
\date{}
...
\protect\phantomsection\label{innehuxe5ll-fuxf6reluxe4sning-5}
\begin{itemize}
\tightlist
\item
  Information del 2
...
\protect\phantomsection\label{r-programmering---del-2}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{R-programmering - del 2}
\protect\phantomsection\label{r-programmering---del-2-1}
\begin{itemize}
\tightlist
\item
  Del 1: Grunderna i programmering:
...
\begin{frame}{R-programmering - del 2}
\protect\phantomsection\label{r-programmering---del-2-2}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{miniprojektet}
...
\protect\phantomsection\label{grafik-i-r}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{enkel-grafik-plot}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{plot---exempel}
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{diagramtyper}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{hist---exempel}
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{bokxplot---exempel}
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{barplot---exempel}
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{pie---exempel}
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tab }\OtherTok{\textless{}{-}} \FunctionTok{table}\NormalTok{(iris}\SpecialCharTok{$}\NormalTok{Species)}
...
\protect\phantomsection\label{luxe5gnivuxe5grafik}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{demo-grafik}
\end{block}
\end{frame}
...
\protect\phantomsection\label{slumptal-och-simulering---i}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{slumptal-och-simulering---ii}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{slumptal-och-simulering---exempel}
\begin{Shaded}
\begin{Highlighting}[]
...
\begin{verbatim}
## [1] -0.9786469  0.5199427 -0.3734885
\end{verbatim}
...
\begin{frame}[fragile]{Slumptal och simulering - Exempel}
\protect\phantomsection\label{slumptal-och-simulering---exempel-1}
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{demo-slumptal}
\end{block}
\end{frame}
...
\protect\phantomsection\label{r-markdown-knitr-och-notebooks-1}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{r-markdown}
\begin{itemize}
\tightlist
\item
  Markupspråk
...
\begin{frame}{knitr}
\protect\phantomsection\label{knitr}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{r-studio-notebooks}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Demo}
\protect\phantomsection\label{demo-2}
\begin{block}{Demo: Markdown}
\protect\phantomsection\label{demo-markdown}
\end{block}
\end{frame}
...
\protect\phantomsection\label{externa-data}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{ladda-ner-och-luxe4sa-in-fruxe5n-webben}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{vanliga-kuxe4llor-fuxf6r-data}
\begin{itemize}
\tightlist
\item
  Dropbox
...
\protect\phantomsection\label{pxweb-api}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{pxweb}
\begin{Shaded}
\begin{Highlighting}[]
...
\begin{frame}{Demo}
\protect\phantomsection\label{demo-3}
\begin{block}{Demo: PXWEB}
\protect\phantomsection\label{demo-pxweb}
\end{block}
\end{frame}
