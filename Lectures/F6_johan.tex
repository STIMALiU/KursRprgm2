...
\subtitle{\texorpdfstring{Föreläsning 6}{Föreläsning 6}}
...
\protect\phantomsection\label{innehuxe5ll-fuxf6reluxe4sning-6}
\begin{itemize}
\tightlist
\item
  Information
...
\protect\phantomsection\label{information-1}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{programmeringsparadigm-1}
\begin{itemize}
\item
...
\protect\phantomsection\label{funktionell-programmering}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{objektorientering}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Objektorientering}
\protect\phantomsection\label{objektorientering-1}
\begin{itemize}
\tightlist
\item
  i R:
...
\protect\phantomsection\label{generiska-funktioner-s3}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Metoder}
\protect\phantomsection\label{metoder}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{demo-objektorientering}
\end{block}
\end{frame}
...
\protect\phantomsection\label{datum-och-tid-1}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{datum-och-tid---exempel}
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{lubridate}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{lubridate---exempel}
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{lubridate-1}
...
\begin{frame}[fragile]{lubridate}
\protect\phantomsection\label{lubridate-2}
...
\begin{frame}[fragile]{lubridate - Exempel}
\protect\phantomsection\label{lubridate---exempel-1}
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{idag }\OtherTok{\textless{}{-}} \FunctionTok{ymd}\NormalTok{(}\StringTok{"2024{-}05{-}06"}\NormalTok{)}
\FunctionTok{week}\NormalTok{(idag)}
...
\begin{frame}{lubridate}
\protect\phantomsection\label{lubridate-3}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{instant-och-interval}
\textbf{Instant}
...
\protect\phantomsection\label{instant-och-interval---exempel}
\begin{Shaded}
\begin{Highlighting}[]
...
\begin{verbatim}
## [1] 2020-02-29 UTC--2026-05-04 UTC
\end{verbatim}
\end{frame}

\begin{frame}{duration}
\protect\phantomsection\label{duration}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{duration---exempel}
\begin{Shaded}
\begin{Highlighting}[]
...
\begin{verbatim}
## [1] "194918400s (~6.18 years)"
\end{verbatim}
\end{frame}

\begin{frame}{Period}
\protect\phantomsection\label{period}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{period---exempel}
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{att-ruxe4knamed-tid---exempel}
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{demo-datum-och-tid}
\end{block}
\end{frame}
...
\protect\phantomsection\label{matriser}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{linjuxe4r-algebra-1}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{linjuxe4r-algebra---paketet-matrix}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{demo-linjuxe4r-algebra}
\end{block}
\end{frame}
