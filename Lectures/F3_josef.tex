...
\phantomsection\label{fuxf6reluxe4sning-3}
\begin{itemize}
\tightlist
\item
  Villkorssatser
...
\phantomsection\label{programkontroll-1}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{vilkorssatser-if-else}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{if---else-if---else}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{villkorssatser---exempel}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{villkorssatser---exempel-ii}
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{prgm }\OtherTok{\textless{}{-}} \StringTok{"Excel"}
...
\begin{frame}{Villkorssatser}
  Vi ställer frågor till programmet/data:
  \begin{itemize}
  \item
    Flera oberoende ja/nej-frågor $\rightarrow$ flera oberoende if-satser
  \item
    Beroende ja/nej-frågor $\rightarrow$ if-else-sats
  \item
    Fråga med fler än två svarsalternativ $\rightarrow$ if-else-sats
  \item
    Bra att rita ett beslutsträd som visualiserar if-else-satser!
  \end{itemize}
...
\phantomsection\label{demo-if-satser}
\end{block}
\end{frame}
...
\phantomsection\label{for-loop---exempel}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{for-loop---exempel-ii}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{for-loop---exempel-iii}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{demo-for-loopar}
\end{block}
\end{frame}
...
\phantomsection\label{nuxe4stlade-loopar-1}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{nuxe4stlade-loopar---exmepel}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{demo-nuxe4stlade-loopar}
\end{block}
\end{frame}
...
\phantomsection\label{while-loop-1}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{while-loop---exempel}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{demo-while-loopar}
\end{block}
\end{frame}
...
\phantomsection\label{kontrollstrukturer-fuxf6r-loopar-1}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{next---exempel}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{break---exempel}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{stop---exempel}
\begin{Shaded}
\begin{Highlighting}[]
\ControlFlowTok{for}\NormalTok{ ( i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\DecValTok{3}\NormalTok{ ) \{}
  \ControlFlowTok{for}\NormalTok{ ( letter }\ControlFlowTok{in} \FunctionTok{c}\NormalTok{(}\StringTok{"a"}\NormalTok{,}\StringTok{"b"}\NormalTok{,}\StringTok{"c"}\NormalTok{) ) \{}
...
\phantomsection\label{demo-kontrollstrukturer}
\end{block}
\end{frame}
...
\phantomsection\label{varningsmeddelanden}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{varningsmeddelanden---exempel}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{debugging-ii}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Demo}
\phantomsection\label{demo-5}
\begin{block}{Demo: browser och debug}
\phantomsection\label{demo-browser-och-debug}
\end{block}
\end{frame}
